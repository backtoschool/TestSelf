 ...
 */
public class Sci2Test5Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sci2test5_layout);
    ...
    public void onClickNext(View view){
        ...
        try{
            ...
            if(strAns.equals("")){
                ...
                Toast.makeText(Sci2Test5Activity.this, "กรุณาเลือกคำตอบด้วยค่ะ",
                ...
                objIntent = new Intent(Sci2Test5Activity.this, Sci2Test6Activity.class);
            ...
            Log.d("Database", "Sci2Test5Activity Error " + e.toString());
...
*/
        ...
        long updateData = objMyDBClass.Update_Data_sciencescore_t2(strMenberID, null, null, null, null, strAns, null, null, null, null);

        Log.d("Database", "Sci2Test5Activity insert DB Success !!!!!" + strAns);
