 ...
 */
public class Sci1Test6Activity extends Activity {
    ...
    public void onClickNext(View view){
        ...
        try{
            ...
            if(strAns.equals("")){
                ...
                Toast.makeText(Sci1Test6Activity.this, "กรุณาเลือกคำตอบด้วยค่ะ",
            ...
            Log.d("insertDB", "Sci1Test6Activity Error " + e.toString());
    ...
    public void UpdateDataSQLite(){
        ...
        */
        ...
        long updateData = objMyDBClass.Update_Data_sciencescore_t1("1", null, null, null, null, null, strAns, null, null, null, null, null);
