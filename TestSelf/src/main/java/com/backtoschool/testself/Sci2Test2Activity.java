...
public class Sci2Test2Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sci2test2_layout);
    ...
    public void onClickNext(View view){
        ...
        try{
            ...
            if(strAns.equals("")){
                ...
                Toast.makeText(Sci2Test2Activity.this, "กรุณาเลือกคำตอบด้วยค่ะ",
                ...
                objIntent = new Intent(Sci2Test2Activity.this, Sci2Test3Activity.class);
            ...
            Log.d("insertDB", "Sci2Test2Activity Error " + e.toString());
    ...
    public void UpdateDataSQLite(){
        ...
        long updateData = objMyDBClass.Update_Data_sciencescore_t2(null, null, null, null, strAns, null, null, null, null, null, null, null);
