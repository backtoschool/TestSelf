 ...
 */
public class Sci2Test6Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sci2test6_layout);
    ...
    public void onClickNext(View view){
        ...
        try{
            ...
            if(strAns.equals("")){
                ...
                Toast.makeText(Sci2Test6Activity.this, "กรุณาเลือกคำตอบด้วยค่ะ",
                ...
                objIntent = new Intent(Sci2Test6Activity.this, Sci2Test7Activity.class);
            ...
            Log.d("Database", "Sci2Test6Activity Error " + e.toString());
    ...
    public void UpdateDataSQLite(){
        ...
        */
        ...
        long updateData = objMyDBClass.Update_Data_sciencescore_t2(strMenberID, null, null, null, null, null, strAns, null, null, null);

        Log.d("Database", "Sci2Test6Activity insert DB Success !!!!!" + strAns);
