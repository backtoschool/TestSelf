...
public class Sci2Test7Activity extends Activity {
    ...
    public void UpdateDataSQLite(){
        ...
        */
        ...
        long updateData = objMyDBClass.Update_Data_sciencescore_t2(strMenberID, null, null, null, null, null, null, strAns, null, null);

        Log.d("Database", "Sci2Test7Activity insert DB Success !!!!!" + strAns);
