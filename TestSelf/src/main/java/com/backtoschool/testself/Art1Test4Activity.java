...
public class Art1Test4Activity extends Activity {
    ...
    public void onClickNext(View view){
        ...
        try{
            ...
            Log.d("Database", "Art1Test4Activity Error " + e.toString());
    ...
    public void UpdateDataSQLite(){
        ...
        long insertID = objMyDBClass.Update_Data_artscore_t1(strMenberID, null,  null, strAns, null, null);

        Log.d("Database", "Art1Test4Activity insert DB Success !!!!!" + strAns);
