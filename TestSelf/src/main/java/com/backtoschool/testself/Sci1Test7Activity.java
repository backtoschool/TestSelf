 ...
 */
public class Sci1Test7Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sci1test7_layout);
    ...
    public void onClickNext(View view){
        ...
        try{
            ...
            if(strAns.equals("")){
                ...
                Toast.makeText(Sci1Test7Activity.this, "กรุณาเลือกคำตอบด้วยค่ะ",
                ...
                objIntent = new Intent(Sci1Test7Activity.this, Sci1Test8Activity.class);
            ...
            Log.d("Database", "Sci1Test7Activity Error " + e.toString());
    ...
    public void UpdateDataSQLite(){
        ...
        */
        ...
        long updateData = objMyDBClass.Update_Data_sciencescore_t1(strMenberID, null, null, null, null, null, strAns, null, null, null, null);

        Log.d("Database", "Sci1Test7Activity update DB Success !!!!!" + strAns);
