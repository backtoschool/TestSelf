...
public class Art1Test2Activity extends Activity {
    ...
    public void onClickNext(View view){
        ...
        try{
            ...
            if(strAns.equals("")){
                ...
                Toast.makeText(Art1Test2Activity.this, "กรุณาเลือกคำตอบด้วยค่ะ",
            ...
            Log.d("Database", "Art1Test2Activity Error " + e.toString());
    ...
    public void UpdateDataSQLite(){
        ...
        long insertID = objMyDBClass.Update_Data_artscore_t1(strMenberID, strAns, null, null, null, null);

        Log.d("Database", "Art1Test2Activity insert DB Success !!!!!" + strAns);
